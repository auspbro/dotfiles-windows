...
From PowerShell:
```posh
git clone https://github.com/auspbro/dotfiles-windows.git; cd dotfiles-windows; . .\bootstrap.ps1
```
...
```bash
iex ((new-object net.webclient).DownloadString('https://raw.githubusercontent.com/auspbro/dotfiles-windows/refs/heads/master/setup/install.ps1'))
```
